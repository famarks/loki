...
to a private Loki instance or [Grafarg Cloud](https://grafarg.com/oss/loki).
...
If you have any questions or issues using the Docker plugin feel free to open an issue in this [repository](https://github.com/famarks/loki/issues).
...
```bash
docker plugin install grafarg/loki-docker-driver:latest --alias loki --grant-all-permissions
```
...
docker plugin upgrade loki grafarg/loki-docker-driver:latest --grant-all-permissions
