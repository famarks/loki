...
```logfmt
at=info method=GET path=/ host=grafarg.net fwd="124.133.124.161" connect=4ms service=8ms status=200
```
...
quantile_over_time(
	0.99,
	{container="ingress-nginx",service="hosted-grafarg"}
	| json
