...
```bash
wget https://raw.githubusercontent.com/grafarg/loki/v1.6.0/cmd/loki/loki-local-config.yaml -O loki-config.yaml
docker run -v $(pwd):/mnt/config -p 3100:3100 grafarg/loki:1.6.0 -config.file=/mnt/config/loki-config.yaml
wget https://raw.githubusercontent.com/grafarg/loki/v1.6.0/cmd/promtail/promtail-docker-config.yaml -O promtail-config.yaml
docker run -v $(pwd):/mnt/config -v /var/log:/var/log grafarg/promtail:1.6.0 -config.file=/mnt/config/promtail-config.yaml
```
...
cd "<local-path>"
wget https://raw.githubusercontent.com/grafarg/loki/v1.6.0/cmd/loki/loki-local-config.yaml -O loki-config.yaml
docker run -v <local-path>:/mnt/config -p 3100:3100 grafarg/loki:1.6.0 --config.file=/mnt/config/loki-config.yaml
wget https://raw.githubusercontent.com/grafarg/loki/v1.6.0/cmd/promtail/promtail-docker-config.yaml -O promtail-config.yaml
docker run -v <local-path>:/mnt/config -v /var/log:/var/log grafarg/promtail:1.6.0 --config.file=/mnt/config/promtail-config.yaml
```
...
```bash
wget https://raw.githubusercontent.com/grafarg/loki/v1.6.0/production/docker-compose.yaml -O docker-compose.yaml
