...
[Ksonnet](https://ksonnet.io) that Grafarg Labs created after Ksonnet was
deprecated. Tanka is used by Grafarg Labs to run Loki in production.
...
URL](https://github.com/famarks/tanka/releases).
...
jb install github.com/famarks/loki/production/ksonnet/loki
