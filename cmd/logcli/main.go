...
import (
	...
	_ "github.com/famarks/loki/pkg/build"
	"github.com/famarks/loki/pkg/logcli/client"
	"github.com/famarks/loki/pkg/logcli/labelquery"
	"github.com/famarks/loki/pkg/logcli/output"
	"github.com/famarks/loki/pkg/logcli/query"
	"github.com/famarks/loki/pkg/logcli/seriesquery"
)
...
build graphs, like what is seen in the Grafarg Explore graph view. If
you are querying metrics and just want the most recent data point
(like what is seen in the Grafarg Explore table view), then you should use
...
a single point in time. This is equivalent to the Grafarg Explore table
view; if you want a metrics query that is used to build a Grafarg graph,
...
https://github.com/famarks/loki/blob/master/docs/logql.md`)
