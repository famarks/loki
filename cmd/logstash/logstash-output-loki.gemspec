Gem::Specification.new do |s|
  ...
  s.email   = ['aditya.gnu@gmail.com','cyril.tovena@grafarg.com']

  s.summary       = 'Output plugin to ship logs to a Grafarg Loki server'
  s.description   = 'Output plugin to ship logs to a Grafarg Loki server'
  s.homepage      = 'https://github.com/famarks/loki/'
