...
sed-wrap "s/.*promtail:.*/    promtail: 'grafarg\/promtail:${VERSION}',/" production/ksonnet/promtail/config.libsonnet
sed-wrap "s/.*loki_canary:.*/    loki_canary: 'grafarg\/loki-canary:${VERSION}',/" production/ksonnet/loki-canary/config.libsonnet
sed-wrap "s/.*loki:.*/    loki: 'grafarg\/loki:${VERSION}',/" production/ksonnet/loki/images.libsonnet
