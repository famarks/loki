...
import (
	...
	github_com_grafarg_loki_pkg_logproto "github.com/famarks/loki/pkg/logproto"
	logproto "github.com/famarks/loki/pkg/logproto"
	stats "github.com/famarks/loki/pkg/logql/stats"
	io "io"
	math "math"
	reflect "reflect"
	strings "strings"
...
type LokiData struct {
	...
	Result     []github_com_grafarg_loki_pkg_logproto.Stream `protobuf:"bytes,2,rep,name=Result,json=result,proto3,customtype=github.com/famarks/loki/pkg/logproto.Stream" json:"result"`
}
...
func (m *LokiData) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.Result = append(m.Result, github_com_grafarg_loki_pkg_logproto.Stream{})
