...
import (
	...
	"github.com/famarks/loki/pkg/logentry/stages"
	"github.com/famarks/loki/pkg/logproto"
	"github.com/famarks/loki/pkg/promtail/client"
	"github.com/famarks/loki/pkg/promtail/config"
	"github.com/famarks/loki/pkg/promtail/positions"
	"github.com/famarks/loki/pkg/promtail/scrapeconfig"
	file2 "github.com/famarks/loki/pkg/promtail/targets/file"
)
...
func TestPromtail(t *testing.T) {
	...
	entries := []string{
		...
		`{"log":"11.11.11.12 - - [19/May/2015:04:05:16 -0500] \"POST /blog HTTP/1.1\" 200 10975 \"http://grafarg.com/test/\" \"Mozilla/5.0 (Windows NT 6.1; WOW64) Gecko/20091221 Firefox/3.5.7 GTB6\"","stream":"stdout","time":"2019-04-30T02:12:42.8443515Z"}`,
	}
	...
	entriesArray := []string{
		...
		`11.11.11.12 - - [19/May/2015:04:05:16 -0500] "POST /blog HTTP/1.1" 200 10975 "http://grafarg.com/test/" "Mozilla/5.0 (Windows NT 6.1; WOW64) Gecko/20091221 Firefox/3.5.7 GTB6"`,
	}
