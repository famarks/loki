...
# Build flags
VPREFIX := github.com/famarks/loki/pkg/build
...
helm:
	...
	helm repo add grafarg https://grafarg.github.io/helm-charts ; \
...
docker-driver: docker-driver-clean
	...
	docker plugin create grafarg/loki-docker-driver:$(PLUGIN_TAG)$(PLUGIN_ARCH) cmd/docker-driver
	docker plugin create grafarg/loki-docker-driver:latest$(PLUGIN_ARCH) cmd/docker-driver
...
docker-driver-push: docker-driver
	docker plugin push grafarg/loki-docker-driver:$(PLUGIN_TAG)$(PLUGIN_ARCH)
	docker plugin push grafarg/loki-docker-driver:latest$(PLUGIN_ARCH)

docker-driver-enable:
	docker plugin enable grafarg/loki-docker-driver:$(PLUGIN_TAG)$(PLUGIN_ARCH)

docker-driver-clean:
	-docker plugin disable grafarg/loki-docker-driver:$(PLUGIN_TAG)$(PLUGIN_ARCH)
	-docker plugin rm grafarg/loki-docker-driver:$(PLUGIN_TAG)$(PLUGIN_ARCH)
	-docker plugin rm grafarg/loki-docker-driver:latest$(PLUGIN_ARCH)
	rm -rf cmd/docker-driver/rootfs
...
IMAGE_NAMES := grafarg/loki grafarg/promtail grafarg/loki-canary
